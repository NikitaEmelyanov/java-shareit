...
class ShareItTests {
    ...
    void createUser_fullIntegrationTest() {
        ...
        ResponseEntity<UserDto> response = restTemplate.exchange(shareitServerUrl + "/users",
        ...
        assertThat(actualUser).usingRecursiveComparison().ignoringFields("id")
    ...
    void getItemsOfOwner_fullIntegrationTest() {
        ...
        ru.practicum.shareit.item.dto.NewItemRequest itemToSave = ru.practicum.shareit.item.dto.NewItemRequest.builder()
            .name(itemName).description(description).available(available).build();

        HttpHeaders headers = new HttpHeaders();
        headers.set("Content-Type", "application/json");
        headers.set("X-Sharer-User-Id", ownerId.toString());
        HttpEntity<ru.practicum.shareit.item.dto.NewItemRequest> itemRequest = new HttpEntity<>(
            itemToSave, headers);
    ...
    void getBookingsByOwner_fullIntegrationTest() {
        ...
        URI uri = UriComponentsBuilder.fromHttpUrl(shareitServerUrl + "/bookings/owner")
            ...
            .build()
            .toUri();
        ResponseEntity<BookingDto[]> biikingByOwnerResponse = restTemplate.exchange(uri,
            HttpMethod.GET, bookingRequest, BookingDto[].class);
    ...
    void getRequest_fullIntegrationTest() {
        ...
        ResponseEntity<ItemRequestDto> itemResponse = restTemplate.exchange(
            shareitServerUrl + "/requests",
        ...
        ResponseEntity<ItemRequestDto> itemResponseById = restTemplate.exchange(
            shareitServerUrl + "/requests/" + itemRequestId,
        ...
        assertThat(actualItemRequestById).usingRecursiveComparison()
            .ignoringFields("created", "items").isEqualTo(actualItemRequest);
    }
