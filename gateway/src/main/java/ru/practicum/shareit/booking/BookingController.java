...
public class BookingController {
    ...
    public ResponseEntity<Object> bookItem(@RequestHeader("X-Sharer-User-Id") long userId,
        ...
        if (requestDto.getStart().isAfter(requestDto.getEnd()) || requestDto.getStart()
            .equals(requestDto.getEnd())) {
            throw new IllegalArgumentException(
                String.format("The booking period is not correct. Start %s, end %s",
