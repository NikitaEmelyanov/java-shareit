...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingServiceImpl(
        ...
        this.bookerBookingStrategies = Map.of(
                ...
                userId -> bookingRepository.findByBookerIdAndStatus(userId, STATUS.WAITING, sort),
                BookingState.REJECTED,
                userId -> bookingRepository.findByBookerIdAndStatus(userId, STATUS.REJECTED, sort)
        );
        ...
        this.ownerBookingStrategies = Map.of(
                ...
                BookingState.WAITING,
                userId -> bookingRepository.findByItem_OwnerIdAndStatus(userId, STATUS.WAITING, sort),
                BookingState.REJECTED,
                userId -> bookingRepository.findByItem_OwnerIdAndStatus(userId, STATUS.REJECTED, sort)
        );
    }
